...
<div class="card h-100 d-flex flex-column">
    ...
    <div style="background-color: #FFD700;" class="card-body flex-grow-1">
        <div class="col-12 h-100">
            <div class="row h-100">
                <div class="col-md-6 h-100 d-flex flex-column">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Gas Type List</b></div>
...
<script>
    $(function(){
        ...
        $('#new_petrol_type').click(function(){
            uni_modal('Add New Gas Type',"manage_petrol_type.php")
        })
        $('.edit_petrol_type').click(function(){
            uni_modal('Edit Gas Type Details',"manage_petrol_type.php?id="+$(this).attr('data-id'))
        })
        $('.view_petrol_type').click(function(){
            uni_modal('Gas Type Details',"view_petrol_type.php?id="+$(this).attr('data-id'))
        })
        $('.delete_petrol_type').click(function(){
            _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from Petrol Type List?",'delete_petrol_type',[$(this).attr('data-id')])
        })
    })
