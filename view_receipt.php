...
<div class="container-fluid">
    <div id="outprint_receipt">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    <td class="px-1 py-0 align-middle"><?php echo round($liter, 2) ?></td>
                    <td class="px-1 py-0 align-middle">
                        <div class="fw light lh-1">
                            <small><?php echo $petrol ?></small><br>
                            <small>(<?php echo round(number_format($price,2)) ?>)</small>
                        </div>
                    </td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="px-1 py-0 text-end"><?php echo round(number_format($amount * ($discount / 100),2)) ?></th>
                </tr>
                <tr>
                    <th class="px-1 py-0" colspan="2">Total</th>
                    <th class="px-1 py-0 text-end"><?php echo round(number_format($total,2)) ?></th>
                </tr>
                <tr>
                    <th class="px-1 py-0" colspan="2">Tendered Amount</th>
                    <th class="px-1 py-0 text-end"><?php echo round(number_format($tendered_amount,2)) ?></th>
                </tr>
                <tr>
                    <th class="px-1 py-0" colspan="2">Change</th>
                    <th class="px-1 py-0 text-end"><?php echo round(number_format($change,2)) ?></th>
                </tr>
            </tfoot>
        </table>
        <div class="fs-6 fs-light d-flex w-100 mb-1">
